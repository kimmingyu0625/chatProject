package com.side.project.chat.repository;

import com.side.project.chat.entity.UserInfo;
...
public class UserRepository implements JpaRepository<UserInfo, String> {
    @Override
    ...
    @Override
    public List<UserInfo> findAllById(Iterable<String> strings) {
        return null;
    }
    ...
    @Override
    public UserInfo getOne(String s) {
        return null;
    }

    @Override
    public UserInfo getById(String s) {
        return null;
    }
